...
171. 爱乌体型变为大体型以后，模型的鼠标选取范围将变得非常大，跟爱乌的攻击距离一致。---2.3版本修复
171. 魔能射手的远程法术战斗无法开启 ---已修复
171. 杀手佯攻是让敌人进行灵巧检定，失败了则佯攻无效，成功了则佯攻有效；而不是自己用灵巧检定替代哄骗检定。~~终结佯攻无效，听说得至少两个人点出来才能生效，变成团队专长~~。---部分修复
171. 错乱之创无效、石化打击无效。---已修复
...
28. 元素狂潮修改了描述，但是实际效果只是原来的元素狂潮，只是新增了音波可以触发。

26. 酷热之风的判定时间改变为施法的回合开始，敌人在自己回合可以用移动动作起身了，连续控制的效果减弱，对施法者的控制效果几乎没有了。目前造成倒地的法术，只有酷热之风修改为这个版本。有可能后期会把油腻术和凛冬之握也修复成这种。
